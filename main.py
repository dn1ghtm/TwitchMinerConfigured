...
twitch_miner = TwitchChannelPointsMiner(
    ...
    logger_settings=LoggerSettings(
        ...
        discord=Discord(
            webhook_api="https://discord.com/api/webhooks/1293310098650693673/8JgVKm2m0Zd_6xlaVxOeYKouhbv589Lni650lJ5sgJxw8Tv3HlLHrSILvqAehxN2ven_",  # Discord Webhook URL
            events=[Events.STREAMER_ONLINE, Events.STREAMER_OFFLINE,
                    Events.BET_LOSE, Events.CHAT_MENTION, Events.GAIN_FOR_WATCH, Events.GAINS_FOR_CLAIM, Events.BET_WIN, Events.BET_LOSE, Events.GAINS_FOR_WATCH_STREAK],                                  # Only these events will be sent to the chat
        ),
        matrix=Matrix(
